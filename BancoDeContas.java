    ...
    public void abrirContaCorrente(LocalDate data) {
        ...
        if (acharContaCorrentePorCPF(cpf) == -1) {
            if (acharContaPoupancaPorCPF(cpf) == -1) {
                ...
                ContaCorrente contaCorrente = new ContaCorrente(registrador.lerString("Insira o seu nome"), cpf,
                        registrador.lerData("Insira sua data de nascimento"),
                        registrador.lerEmail("Insira o seu email"), registrador.lerTelefone("Insira o seu telefone"),
                        registrador.lerString("Insira a sua senha"), numeroDaConta, data, 0);
                ...
                ContaCorrente contaCorrente = new ContaCorrente(copiaDaContaPoupanca.getNome(), cpf,
                        copiaDaContaPoupanca.getDataDeNascimento(), copiaDaContaPoupanca.getEmail(),
                        copiaDaContaPoupanca.getTelefone(), copiaDaContaPoupanca.getSenha(), numeroDaConta,
                        copiaDaContaPoupanca.getDataDeCriacao(), 0);
    ...
    public void abrirContaPoupanca(LocalDate data) {
        ...
        if (acharContaPoupancaPorCPF(cpf) == -1) {
            if (acharContaCorrentePorCPF(cpf) == -1) {
                ...
                ContaPoupanca contaPoupanca = new ContaPoupanca(registrador.lerString("Insira o seu nome"), cpf,
                        registrador.lerData("Insira sua data de nascimento"),
                        registrador.lerEmail("Insira o seu email"), registrador.lerTelefone("Insira o seu telefone"),
                        registrador.lerString("Insira a sua senha"), numeroDaConta, data, 0);
                ...
                ContaPoupanca contaPoupanca = new ContaPoupanca(copiaDaContaCorrente.getNome(), cpf,
                        copiaDaContaCorrente.getDataDeNascimento(), copiaDaContaCorrente.getEmail(),
                        copiaDaContaCorrente.getTelefone(), copiaDaContaCorrente.getSenha(), numeroDaConta,
                        copiaDaContaCorrente.getDataDeCriacao(), 0);
